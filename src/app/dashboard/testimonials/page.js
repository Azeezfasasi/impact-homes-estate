                      ...
                      <div className="space-y-2 pt-4 border-t border-gray-200">
                        <div className="flex gap-2 flex-wrap">
                          <button
                            ...
                            className="flex items-center justify-center gap-2 px-3 py-2 bg-impact-gold text-white rounded hover:bg-impact-gold/15 transition-colors text-sm font-medium flex-1"
                          >
                ...
                <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-6">
                  ...
                  <div className="flex gap-3 pt-6 border-t border-gray-200">
                    ...
                    <button
                      type="submit"
                      disabled={saving}
                      className="flex-1 px-4 py-2.5 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/70 font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                    >
