  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="flex items-center gap-2 bg-impact-gold text-white px-4 py-2 rounded-lg hover:bg-impact-gold/80"
      >
            ...
            <div key={milestone._id} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              <div className="flex items-center gap-2 mt-3">
                <button
                  ...
                  className="flex items-center gap-1 bg-impact-gold text-white px-3 py-1 rounded text-sm hover:bg-impact-gold/80"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-impact-gold/70 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-impact-gold"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-impact-gold/70 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-impact-gold resize-none h-24"
              ...
              <div className="flex gap-2 justify-end pt-4">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80"
                >
