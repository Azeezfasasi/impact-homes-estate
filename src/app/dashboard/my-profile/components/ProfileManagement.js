        ...
        <div className="flex space-x-4 mb-8 border-b border-gray-200">
          <button
            ...
            className={`px-4 py-3 font-medium border-b-2 transition ${
              activeTab === 'profile'
                ? 'border-impact-gold text-impact-gold'
            ...
            <form onSubmit={handleProfileSubmit} className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-8 pb-8 border-b border-gray-200">
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80 transition font-medium"
                  >
                    Change Photo
                  </button>
                  <input
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-impact-gold/70 rounded-lg focus:outline-none focus:ring-2 focus:ring-impact-gold transition disabled:bg-gray-100"
                    placeholder="John"
                  />
                </div>
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  disabled={profileLoading}
                  className="px-8 py-2 md:py-3 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80 disabled:opacity-60 disabled:cursor-not-allowed transition font-medium"
                >
            ...
            <form onSubmit={handlePasswordSubmit} className="max-w-xl space-y-6">
              ...
              <div className="flex justify-end pt-4">
                <button
                  type="submit"
                  disabled={passwordLoading}
                  className="px-8 py-3 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80 disabled:opacity-60 disabled:cursor-not-allowed transition font-medium"
                >
