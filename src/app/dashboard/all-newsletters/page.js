      ...
      <div className="flex flex-col lg:flex-row items-center justify-between">
        <div>
          <h1 className="text-[20px] md:text-2xl font-bold text-gray-900 flex items-center space-x-2">
            <BarChart3 className="w-8 h-8 text-impact-gold" />
        ...
        <Link
          ...
          className="px-4 py-2 bg-impact-gold text-white rounded-lg font-medium hover:bg-impact-gold/80 transition-colors flex items-center space-x-2 mt-4 lg:mt-0"
        >
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            <div className="w-12 h-12 border-4 border-impact-gold/70 border-t-impact-gold rounded-full animate-spin mx-auto mb-4"></div>
        ...
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          ...
          <Link
            href="/dashboard/send-newsletter"
            className="mt-4 inline-block px-4 py-2 text-impact-gold hover:text-impact-gold/80 font-medium"
          >
