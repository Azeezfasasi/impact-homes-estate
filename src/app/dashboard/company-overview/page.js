        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-impact-gold/70 rounded-lg focus:ring-2 focus:ring-impact-gold"
                />
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-impact-gold/70 rounded-lg cursor-pointer hover:border-impact-gold/80 hover:bg-impact-gold/15 transition">
                  ...
                  {companyInfoForm.paragraphs.map((para, idx) => (
                    <div key={idx} className="flex gap-2">
                      <textarea
                        ...
                        rows="3"
                        className="flex-1 px-3 py-2 border border-impact-gold/70 rounded text-sm focus:ring-2 focus:ring-impact-gold"
                      />
              ...
              <button onClick={saveCompanyInfo} disabled={saving} className="w-full px-4 py-2.5 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/70 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
          ...
          {activeTab === 'vision' && (
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              ...
              <button onClick={saveVision} disabled={saving} className="w-full px-4 py-2.5 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
                {saving && <Loader className="w-4 h-4 animate-spin" />}
                Save Vision
              </button>
            </div>
          ...
          {activeTab === 'mission' && (
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              ...
              <button onClick={saveMission} disabled={saving} className="w-full px-4 py-2.5 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
                {saving && <Loader className="w-4 h-4 animate-spin" />}
                Save Mission
              </button>
            </div>
          ...
          {activeTab === 'coreValues' && (
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div className="space-y-2">
                  {coreValuesForm.map((value, idx) => (
                    <div key={idx} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-white">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleEditCoreValue(idx)} className="text-impact-gold hover:text-impact-gold/80">
              ...
              <button onClick={saveCoreValues} disabled={saving} className="w-full px-4 py-2.5 bg-impact-gold text-white rounded-lg hover:bg-impact-gold/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
                {saving && <Loader className="w-4 h-4 animate-spin" />}
                Save Core Values
              </button>
            </div>
