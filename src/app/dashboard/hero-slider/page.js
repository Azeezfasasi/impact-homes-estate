                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-impact-gold text-white rounded hover:bg-impact-gold/80 transition-colors text-sm font-medium"
                        >
            ...
            <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
              <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Slide Image * {imageUploading && <span className="text-impact-gold">(Uploading...)</span>}
                    </label>
