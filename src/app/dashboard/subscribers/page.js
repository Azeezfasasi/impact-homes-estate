      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
        <div>
          <h1 className="text-[20px] md:text-2xl font-bold text-gray-900 flex items-center space-x-2">
            <Users className="w-5 md:w-8 h-5 md:h-8 text-impact-gold" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-impact-gold/70 rounded-lg focus:outline-none focus:ring-2 focus:ring-impact-gold"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2 border border-impact-gold/70 rounded-lg focus:outline-none focus:ring-2 focus:ring-impact-gold"
          >
          ...
          {/* Stats */}
          <div className="px-4 py-2 bg-impact-gold/5 rounded-lg border border-impact-gold/20">
            <p className="text-[14px] text-impact-gold">Total Subscribers</p>
            <p className="text-lg font-semibold text-impact-gold">{subscribers.length}</p>
          </div>
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-12 overflow-auto">
          <div className="text-center">
            <div className="w-12 h-12 border-4 border-impact-gold/20 border-t-impact-gold rounded-full animate-spin mx-auto mb-4"></div>
            <p className="text-gray-600">Loading subscribers...</p>
          </div>
        </div>
      ) : subscribers.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          <Users className="w-12 h-12 text-impact-gold mx-auto mb-4" />
          <p className="text-gray-600">No subscribers found</p>
          <button
            onClick={() => setImportModal({ isOpen: true })}
            className="mt-4 inline-flex items-center space-x-2 px-4 py-2 text-impact-gold hover:text-impact-gold/80 font-medium"
          >
            <Upload className="w-4 h-4" />
        ...
        <>
          <div className="bg-white rounded-lg border border-gray-300 max-w-[350px] lg:max-w-full lg:w-full overflow-auto mx-auto">
            <table className="w-full overflow-x-auto">
              <thead className="bg-gray-50 border-b border-impact-gold/20">
                <tr>
                  <th className="px-6 py-3 text-left w-12">
                    <input
                      ...
                      className="w-4 h-4 text-impact-gold rounded"
                    />
                  </th>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-impact-gold/70 rounded-lg focus:outline-none focus:ring-2 focus:ring-impact-gold"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">
