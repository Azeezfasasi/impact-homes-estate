    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 text-impact-gold hover:text-impact-gold/80 mb-8 font-medium"
          >
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <button
              ...
              className="inline-block bg-impact-gold text-white px-6 py-2 rounded-lg hover:bg-impact-gold/80 transition-colors"
            >
              View All Galleries
            </button>
          </div>
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-2 text-impact-gold hover:text-impact-gold/80 mb-6 sm:mb-8 font-medium"
        >
          <ArrowLeft className="h-5 w-5" />
          Back
        </button>
                      ...
                      <button
                        ...
                        className={`shrink-0 relative w-16 sm:w-20 h-16 sm:h-20 rounded-lg overflow-hidden transition-all ${
                          idx === currentImageIndex
                            ? 'ring-2 ring-impact-gold shadow-md'
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
              <div className="flex items-start justify-between gap-3 mb-4">
                <div>
                  ...
                  {categoryLabel && (
                    <span className="inline-block bg-impact-gold/10 text-impact-gold text-xs sm:text-sm px-3 py-1 rounded-full font-medium">
                      {categoryLabel}
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  {gallery.businessName && (
                    <div className="flex items-start gap-3">
                      <Building2 className="h-5 w-5 text-impact-gold shrink-0 mt-0.5" />
                      <div>
        ...
        <div className="mt-12 sm:mt-16">
          ...
          <button
            onClick={() => router.push('/gallery')}
            className="inline-block bg-impact-gold text-white px-6 sm:px-8 py-3 rounded-lg font-medium hover:bg-impact-gold/80 transition-colors"
          >
            View All Galleries →
          </button>
        </div>
