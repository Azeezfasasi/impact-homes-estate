...
const DEFAULT_DATA = {
  companyInfo: {
    ...
    paragraphs: [
      { text: 'Impact Homes Real Estate is a dynamic, solutions-driven Real Estate Company committed to delivering world-class services across multiple sectors. Established in 2020 and legally incorporated in Nigeria in 2025 with a passion for innovation, real estate excellence, and sustainable project delivery.', order: 0 },
      { text: 'We bring together nearly two decades of multidisciplinary real estate experience', order: 1 },
